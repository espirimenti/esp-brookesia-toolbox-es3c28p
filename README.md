...
Planned ports from the original S3 Toolbox include Logic Analyzer, Wi-Fi and BLE scanners, Audio Tool, Settings, storage/export services, and the web dashboard.
